...
(12, 'ColdGelo', 'wow', '2025-06-16 18:09:33', 13, 35, 0),
(13, 'ColdGelo', 'what the helly', '2025-06-16 18:10:23', 13, 35, 12),
...
(35, 'ColdGelo', 'Com Lab', '<p>A<strong> computer laboratory,</strong> or computer lab, is a designated space equipped with computers for shared use, typically found in educational institutions, libraries, or other public facilities. These labs provide access to computing resources and software for various purposes, including <u>research, education, and general computer use. </u></p>', '13_testing 5.jpg', '2025-06-17 00:08:48', 13, '2025-06-19 02:10:06'),
...
(47, 'joanaoademis', 'Encantadia', '<p><strong>Encantadia </strong>is a Filipino fantasy television series aired and produced by GMA Network. It was dubbed as the grandest, most ambitious, and most expensive production for Philippine television during its time of release. The pilot episode was aired on<strong><em><u> May 2, 2005</u></em></strong>. Its last episode was aired on December 9 of the same year to give way to its second book, Etheria. This series aired its pilot episode on December 12, and its last episode on <strong><em><u>February 18, 2006</u></em></strong>. The third installment of the Encantadia saga, entitled Encantadia: Pag-ibig Hanggang Wakas, aired its pilot on February 20, 2006 and the series ended on April 28, 2006. The series garnered both popular and critical recognition at home and abroad, including winning the 2005 Teleserye of the Year at the Los Angeles-based Gawad Amerika Awards. The series then had a requel (or re-telling sequel), entitled with the same name. It aired its pilot on<strong><em><u> July 18, 2016</u></em></strong> and its final episode on May 19, 2017.</p>', '15_Encantadia.avif', '2025-06-19 02:45:16', 15, '2025-06-19 02:45:16');
...
ALTER TABLE `comments`
  ...
  ADD CONSTRAINT `fk_post_comment` FOREIGN KEY (`post_id`) REFERENCES `post` (`id`) ON DELETE SET NULL;
